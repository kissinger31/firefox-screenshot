...
Mutex.registry = Object.create(null);
...
Image.prototype.decode = Image.prototype.decode || function () {
  let img = new Image();
  let url = this.src;
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      else reject(new Error('img.onload'));
    };
    img.onerror = (err) => {
      reject(err || new Error('img.onerror'));
    };
    img.src = url;
  });
};
